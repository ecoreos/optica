ecore.define('web.framework', function (require) {
"use strict";
...
if ($.blockUI) {
    ...
    $.blockUI.defaults.message = '<div class="ecore oe_blockui_spin_container" style="background-color: transparent;">';
...
//  * If params.wait, reload will wait the ecore server to be reachable before reloading
...
$.fn.ecoreClass = function(additionalClass) {
    // This plugin should be applied on top level elements
    additionalClass = additionalClass || '';
    if (!!$.browser.msie) {
        additionalClass += ' ecore_ie';
    }
    return this.each(function() {
        $(this).addClass('ecore ' + additionalClass);
    });
};
$.fn.ecoreBounce = function() {
    return this.each(function() {
...
ecore.define('web.IFrameWidget', function (require) {
"use strict";
