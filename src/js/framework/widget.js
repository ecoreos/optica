ecore.define('web.Widget', function (require) {
"use strict";
 ...
 *
 * MyWidget = ecore.base.Widget.extend({
...
var Widget = core.Class.extend(mixins.PropertiesMixin, {
     ...
     *
     * @constructs ecore.Widget
     *
     * @param {ecore.Widget} parent Binds the current instance to the given Widget instance.
     ...
     * eCore Web where developers may want to replace existing callbacks with
     * theirs.
     *
