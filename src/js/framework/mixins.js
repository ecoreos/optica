ecore.define('web.mixins', function (require) {
"use strict";
...
function eCoreEvent (target, name, data) {
    this.target = target;
    this.name = name;
...
eCoreEvent.prototype.stop_propagation = function () {
    this.stopped = true;
};

eCoreEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function(name, info) {
        var event = new eCoreEvent(this, name, info);
