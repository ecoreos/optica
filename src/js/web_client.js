ecore.define('web.WebClient', function (require) {
"use strict";
...
var WebClient = Widget.extend({
    ...
    init: function(parent, client_options) {
        ...
        this.set('title_part', {"zecore": "eCore"});
    },
    start: function() {
        var self = this;
    ...
    bind_events: function() {
        ...
        /*
            Small patch to allow having a link with a href towards an anchor. Since ecore use hashtag 
